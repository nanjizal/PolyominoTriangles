...
import polyominoTriangles.game.PolyominoTriangles;
...
class PolyominoTrianglesKha4 {
    ...
    var polyominoTriangles: PolyominoTriangles;
    public function new(){
        ...
        polyominoTriangles = new PolyominoTriangles();
        var mouse = Mouse.get();
