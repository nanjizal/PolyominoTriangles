...
class Controller {
    ...
    var hi:         Int;
    var diaSq:      Float;
    public var onPolyominoShapeLanded: Void->Void;
    ...
    public function new(    id_:    Int,    triangles_: Array<Triangle>
        ...
        shapeGenerator = new ShapeGenerator( createPolyomino );
    }
    public function createShape( p: Point, col0_: Int, col1_: Int, ?shapePreference: PolyominoShape = polyomino_random ){
        col0      = col0_;
        col1      = col1_;
    ...
    function hitBottom(){
        ...
        if( end ) onGameEnd();
        if( onPolyominoShapeLanded != null && hit && !end ) onPolyominoShapeLanded();
        return hit;
    }
    ...
    function shapesOnBg(){
        ...
        background.drawPolyomino( shapeLocations, 0, 0 );
    }   
    public inline 
    ...
    public inline function createPolyomino( p: Point, ?snapped: Snapped ){
    ...
    public function createBottom( p: Point, wide: Int , col0_: Int, col1_: Int ){
        var templates = new Templates( createPolyomino );
        col0   = col0_;
        col1   = col1_;
    ...
    //public inline function hitBottomOld(){
        ...
        for( i in 0...tl ){
            for( p in 0...pl ){
                //if( polyominoShapes[ i ].hitTest( points[ p ] ) ){
