...
class PolyominoTrianglesFlash extends Sprite{ 
    ...
    public static function main(): Void { Lib.current.addChild( new PolyominoTrianglesFlash() ); }
    public function new(){
        super();
