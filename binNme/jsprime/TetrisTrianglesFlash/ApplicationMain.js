...
var $hxClasses = (typeof($global['hxClasses'])=='undefined') ? {} : $global['hxClasses'];
var __map_reserved = window.__map_reserved;
var haxe = $hxClasses.package.haxe;
var String = $hxClasses.package.String;
var XmlType = $hxClasses.package.XmlType;
var EnumValue = $hxClasses.package.EnumValue;
var Class = $hxClasses.package.Class;
var ArrayAccess = $hxClasses.package.ArrayAccess;
var _EReg = $hxClasses.package._EReg;
var IntIterator = $hxClasses.package.IntIterator;
var _List = $hxClasses.package._List;
var StringBuf = $hxClasses.package.StringBuf;
var _UInt = $hxClasses.package._UInt;
var js = $hxClasses.package.js;
var Int = $hxClasses.package.Int;
var Map = $hxClasses.package.Map;
var Std = $hxClasses.package.Std;
var Sys = $hxClasses.package.Sys;
var Xml = $hxClasses.package.Xml;
var cpp = $hxClasses.package.cpp;
var nme = $hxClasses.package.nme;
var StringTools = $hxClasses.package.StringTools;
var Dynamic = $hxClasses.package.Dynamic;
var Float = $hxClasses.package.Float;
var Bool = $hxClasses.package.Bool;
var Date = $hxClasses.package.Date;
var EReg = $hxClasses.package.EReg;
var Enum = $hxClasses.package.Enum;
var List = $hxClasses.package.List;
var Math = $hxClasses.package.Math;
var Reflect = $hxClasses.package.Reflect;
var Type = $hxClasses.package.Type;
var UInt = $hxClasses.package.UInt;
var Array = $hxClasses.package.Array;
var Void = $hxClasses.package.Void;
var ValueType = $hxClasses.package.ValueType;
var HxOverrides = $hxClasses.package.HxOverrides;
var _Map = $hxClasses.package._Map;
var _Xml = $hxClasses.package._Xml;
...
var ApplicationBoot = function() { };
ApplicationBoot.__name__ = ["ApplicationBoot"];
var ApplicationMain = function() { };
ApplicationMain.__name__ = ["ApplicationMain"];
ApplicationMain.main = function() {
	haxe.Log.trace = ApplicationMain.jsprimeLog;
	var closePreloader = Module.closePreloader;
	if(closePreloader != null) {
		closePreloader();
	}
	nme.app.Application.setPackage("Nanjizal","TetrisTrianglesFlash","net.nanjizal.tetrisTriangles","1.0.0");
	nme_AssetData.create();
	var flags = 2060;
	nme.Lib.create(function() {
		nme.Lib.get_current().get_stage().set_align(nme.display.StageAlign.TOP_LEFT);
		nme.Lib.get_current().get_stage().set_scaleMode(nme.display.StageScaleMode.NO_SCALE);
		nme.Lib.get_current().loaderInfo = nme.display.LoaderInfo.create(null);
		tetrisTriangles_TetrisTrianglesFlash.main();
	},1024,768,60,16777215,flags,"Tetris Triangles");
};
ApplicationMain.setAndroidViewHaxeObject = function(inObj) {
};
ApplicationMain.jsprimeLog = function(v,infos) {
...
var nme_AssetData = function() { };
nme_AssetData.__name__ = ["nme","AssetData"];
nme_AssetData.create = function() {
	nme.Assets.loadAssetList();
};
var tetrisTriangles_TetrisTrianglesFlash = function() {
	...
	var viewSprite = new nme.display.Sprite();
	this.g = viewSprite.get_graphics();
	this.addChild(viewSprite);
	nme.Lib.get_current().get_stage().addEventListener("keyDown",$bind(this,this.onKeyDown));
	justTriangles_Draw.drawTri = justTriangles_Triangle.drawTri;
	this.tetrisTriangles = new tetrisTriangles_game_TetrisTriangles(1.8);
	nme.Lib.get_current().get_stage().addEventListener("enterFrame",$bind(this,this.enterFrame));
};
tetrisTriangles_TetrisTrianglesFlash.__name__ = ["tetrisTriangles","TetrisTrianglesFlash"];
tetrisTriangles_TetrisTrianglesFlash.main = function() {
	nme.Lib.get_current().addChild(new tetrisTriangles_TetrisTrianglesFlash());
};
tetrisTriangles_TetrisTrianglesFlash.__super__ = nme.display.Sprite;
tetrisTriangles_TetrisTrianglesFlash.prototype = $extend(nme.display.Sprite.prototype,{
	renderTriangles: function() {
		...
		while(_g1 < _g) {
			tri = triangles[_g1++];
			this.g.moveTo(500 + tri.ax * 300,500 + tri.ay * 300);
			this.g.beginFill(this.gameColors[tri.colorID]);
			this.g.lineTo(500 + tri.ax * 300,500 + tri.ay * 300);
			this.g.lineTo(500 + tri.bx * 300,500 + tri.by * 300);
			this.g.lineTo(500 + tri.cx * 300,500 + tri.cy * 300);
			this.g.endFill();
		}
	}
	...
	,__class__: tetrisTriangles_TetrisTrianglesFlash
});
...
{ };
{ };
ApplicationMain.engines = [];
ApplicationMain.winWidth = 1024;
ApplicationMain.winHeight = 768;
ApplicationMain.winBackground = 16777215;
